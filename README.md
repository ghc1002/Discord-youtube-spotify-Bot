A bot I've created to play youtube and spotify audio into a discord voice chat. This requires a second discord user and an open laptop/pc to run it all and open new tabs.
